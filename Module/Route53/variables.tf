# The file Module/Route53/variables.tf
# This file defines input variables for the Route53 module in Terraform.
variable "domain_name" {
    description = "The domain name for the Route53 record (e.g., example.com or www.example.com)"
  type = string
}

# This variable is intended to hold the domain name generated by CloudFront.
variable "cf_domain" {
    description = "The domain name for the CloudFront distribution (e.g., example.com or www.example.com)"
  type = string
}

# This variable holds the hosted zone ID associated with the CloudFront distribution.
# This ID is required to create an ALIAS record in Route 53 that points to the CloudFront distribution.
...
# In summary, these variables are essential for linking a custom domain name to a CloudFront distribution
# using Route 53. They allow users to specify their desired domain name while the configuration